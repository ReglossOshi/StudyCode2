...
<body>
    <div class="card">
        ...
        <form action="/adminNoticeUpdate" method="post" id="form1" onSubmit="return false" enctype="multipart/form-data">
        	...
        	<c:forEach items="${freeBoardVO}" var="freeBoard">
	        <div class="card-write">
	            ...
	            <div class="msg">
	            	...
	            	<input name="filePrev1" type="hidden" value='<c:out value="${freeBoard.file1Path}" />'>
	            	<input name="filePrev2" type="hidden" value='<c:out value="${freeBoard.file2Path}" />'>
	            </div>
	            <br>
	            <div>
...
<!-- 첨부파일1 존재 여부 -->				
									...
									<li style="list-style-type: none;">
										...
										<button onClick="location.href='fileDelete?fileNum=1&noticeNum=<c:out value="${freeBoard.num}" />&fileName=<c:out value="${freeBoard.file1Path}" />'">삭제</button>
									</li>
									...
									<li style="list-style-type: none;">
										...
										<button onClick="location.href='fileDelete?fileNum=2&noticeNum=<c:out value="${freeBoard.num}" />&fileName=<c:out value="${freeBoard.file2Path}" />'">삭제</button>
									</li>
    ...
    <script>
	    const insertSuccessCount = '<c:out value="${updateSuccess}" />';	
