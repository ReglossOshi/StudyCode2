...
<html lang="en">
    <head>
        ...
        <script src="/resources/js/default/scripts.js"></script>
        <script src="/resources/assets/demo/chart-area-demo.js"></script>
        <script src="/resources/assets/demo/chart-bar-demo.js"></script>
        <script src="/resources/js/default/datatables-simple-demo.js"></script>
        <script src="/resources/js/components/components-script.js"></script>
    </head>
